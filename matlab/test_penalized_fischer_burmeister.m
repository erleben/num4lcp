...
[z2 e2 i2 f2 c2 m2] = fischer_newton(M, q, x0, max_iter, tol_rel, tol_abs, true, 'perturbation');
...
% for i = 1:num_test
    ...
    [z1 e1 i1 f1 c1 m1] = penalized_fb(A, b, x0, max_iter, tol_rel, tol_abs, true);
    fprintf('Penalized Fischer-Burmeister:')
    fprintf('Accuracy = %2.5e\tErr = %2.5e iter: %d msg: %s\n', abs(A*z1+b)'*z1, e1, i1, m1);
    
    [z2 e2 i2 f2 c2 m2] = fischer_newton(A, b, x0, max_iter, tol_rel, tol_abs, true, 'perturbation');
