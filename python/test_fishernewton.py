...
from FischerNewtonSolver import FischerNewtonSolver
...
(x, err, iterate, flag, convergence, msg) = fns.solve(A, b, x0, max_iter=None, tol_rel=0.0001, tol_abs=10*np.finfo(np.float64).eps, tol_stg=0.0001, subsolver=None, profile=True, warmstart=None, gradient=None, searchmethod=None)
